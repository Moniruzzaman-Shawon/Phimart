...
SECRET_KEY = 'django-insecure-l4!21*=cv7gaxmqs89yfn=ptr9a91=!$@*b)a-qef4-i((1-wf'
...
CSRF_TRUSTED_ORIGINS = [
    "https://phimart.vercel.app",
    "https://phimart-client.vercel.app",  # only if separate
]
...
# Configuration for cloudinart storage      
cloudinary.config( 
